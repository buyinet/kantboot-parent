...
public class HttpRequestHeaderUtil {
     ...
     * authorization字段
     */
    public final static String FIELD_AUTHORIZATION = "authorization";

    /**
     * kantboot_memory字段
     */
    public final static String FIELD_KANTBOOT_MEMORY = "kantbootMemory";

    /**
     * 语言编码字段
     * 从请求头中获取语言编码字段的值，如果没有语言编码字段则返回null，如果有语言编码字段则返回语言编码字段的值
     */
    public final static String FIELD_LANGUAGE_CODE = "languageCode";

    /**
     * 场景编码字段
     * 从请求头中获取场景编码字段的值，如果没有场景编码字段则返回null，如果有场景编码字段则返回场景编码字段的值
     */
    public final static String FIELD_SCENE_CODE = "sceneCode";
    ...
    public String getToken() {
        return request.getHeader(FIELD_TOKEN);
    }


    /**
     * 获取authorization
     * 原理：从请求头中获取authorization字段的值，如果没有authorization字段则返回null，如果有authorization字段则返回authorization字段的值
     * @return authorization
     */
    public String getAuthorization() {
        return request.getHeader(FIELD_AUTHORIZATION);
    }

    /**
     * 获取kantboot_memory
     * 原理：从请求头中获取kantboot_memory字段的值，如果没有kantboot_memory字段则返回null，如果有kantboot_memory字段则返回kantboot_memory字段的值
     * @return kantboot_memory
     */
    public String getKantbootMemory() {
        return request.getHeader(FIELD_KANTBOOT_MEMORY);
    }
    ...
    public String getLanguageCode() {
        String header = request.getHeader(FIELD_LANGUAGE_CODE);
    ...
    public String getSceneCode() {
        return request.getHeader(FIELD_SCENE_CODE);
    }
