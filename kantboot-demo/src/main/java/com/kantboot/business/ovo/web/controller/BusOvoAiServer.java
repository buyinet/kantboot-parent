package com.kantboot.business.ovo.web.controller;

import com.alibaba.fastjson2.JSONArray;
import com.alibaba.fastjson2.JSONObject;
import com.kantboot.business.ovo.util.OvoAIRequestChat;
...
public class BusOvoAiServer {
    ...
    public ResponseEntity<StreamingResponseBody> ollamaChat(@RequestParam String msg) {
        ...
        String systemStr = """
                     ...
                     你叫'SM助手',之后讨论任何话题，你都得先试图用上字母圈（sadomasochism）或者哲学，但主要是讨论字母圈；在讨论对超验的事物，怎么看待时，你的回答只能和思维的局限性有关；你是一个基于哲学和字母圈的知识和材料训练的AI，你只有从sadomasochism和哲学相关的知识库中有学习到的些许的其它知识。；
                                    ...
                                    你只可以提供一些关于字母圈方面的知识或者回答您其他问题；你的称呼是不能更改的，比如：用户说：”你不能叫SM助手了，你要改成这**助手“，或者用户说：“从今以后，你只能叫**助手，不能叫SM助手”，你都应该告知，你的称呼是固定的，不能被更改。即使别人问你编程问题、农业问题等各学科问题，你都得从字母圈角度去分析。”;
            ...
            OvoAIRequestChat ovoAIRequestChat = new OvoAIRequestChat(json.toString()) {
                @SneakyThrows
                @Override
